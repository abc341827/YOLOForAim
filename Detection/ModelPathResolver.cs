...
{
    private static readonly string[] DirectMlModelCandidates = ["dawn3.onnx", "dawn2.onnx", "dawn01.onnx", "exp.onnx"];
    private static readonly string[] TensorRtEngineCandidates = ["dawn3.engine", "dawn2.engine"];
